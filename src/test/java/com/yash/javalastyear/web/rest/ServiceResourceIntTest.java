...
public class ServiceResourceIntTest {
    ...
    public void createService() throws Exception {
        ...
        assertThat(testService.getServiceID()).isEqualTo(DEFAULT_SERVICE_ID);
        assertThat(testService.getName()).isEqualTo(DEFAULT_NAME);
        assertThat(testService.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
        assertThat(testService.getRequirements()).isEqualTo(DEFAULT_REQUIREMENTS);
        assertThat(testService.getDocuments()).isEqualTo(DEFAULT_DOCUMENTS);
    }
    ...
    public void updateService() throws Exception {
        ...
        Service testService = serviceList.get(serviceList.size() - 1);
        assertThat(testService.getServiceID()).isEqualTo(UPDATED_SERVICE_ID);
        assertThat(testService.getName()).isEqualTo(UPDATED_NAME);
        assertThat(testService.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
        assertThat(testService.getRequirements()).isEqualTo(UPDATED_REQUIREMENTS);
        assertThat(testService.getDocuments()).isEqualTo(UPDATED_DOCUMENTS);
    }

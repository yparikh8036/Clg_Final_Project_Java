...
public class BillResourceIntTest {
    ...
    private static final String DEFAULT_BILL_DOC = "AAAAAAAAAA";
    private static final String UPDATED_BILL_DOC = "BBBBBBBBBB";
    ...
    public void createBill() throws Exception {
        ...
        assertThat(testBill.getBillDoc()).isEqualTo(DEFAULT_BILL_DOC);
    ...
    public void getAllBills() throws Exception {
        ...
        restBillMockMvc.perform(get("/api/bills?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].billDoc").value(hasItem(DEFAULT_BILL_DOC.toString())))
    ...
    public void getBill() throws Exception {
        ...
        restBillMockMvc.perform(get("/api/bills/{id}", bill.getId()))
            ...
            .andExpect(jsonPath("$.billDoc").value(DEFAULT_BILL_DOC.toString()))
    ...
    public void updateBill() throws Exception {
        ...
        assertThat(testBill.getBillDoc()).isEqualTo(UPDATED_BILL_DOC);
